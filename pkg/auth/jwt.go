...
type TokenProvider interface {
	...
	DeleteJWTSession(refreshToken string) error
...
func NewTokenProvider(cfg *Config, redisClient *redis.Client) *Provider {
	return &Provider{
		cfg:         cfg,
...
func (p *Provider) DeleteJWTSession(refreshToken string) error {
	err := p.redisClient.Del(refreshToken).Err()
	return err
}
