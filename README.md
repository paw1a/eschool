...
## Сценарии пользователей по ролям

![user-scenario](docs/images/user-scenario.svg)
...
- Москва
- Не женат, нет детей
- Студент программной инженерии МГТУ им. Баумана
- Хочет пройти курс по Python, чтобы сдать лабораторную в ВУЗе
- Бюджет на курсы невысокий, предпочтение бесплатные курсы
- Необходима теория и практика

### Марина 17 лет
- Саратов
- Учится в региональной школе
- Необходима подготовка к ЕГЭ
- Бюджет неограничен, деньги дают родители
- Ищет курсы от преподавателей ВУЗов или учителей школ
- Сложность курса должна быть высокой для подготовки на 100 баллов

### Олег 40 лет
- Санкт-Петербург
- Преподаватель информатики в школе
- Стаж 15 лет
- Ищет площадку для создания авторского курса по Python для школьников и студентов
- Сложность курса должна расти по мере прохождения
- Есть потребность изложить теорию и практику, передать свой опыт
- Хочет создать платный курс, по приемлемой цене
- Владеет навыками написания текстов и дизайна изображений
